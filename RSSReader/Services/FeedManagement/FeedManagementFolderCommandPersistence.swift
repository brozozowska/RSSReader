...
@MainActor
struct FeedManagementFolderCommandPersistence {
    let logger: Logging
    ...
    func createFolder(_ command: FeedManagementCreateFolderCommand) throws -> FeedManagementFolderSummary {
        ...
        if try folderRepository.fetchFolder(name: normalizedName) != nil {
            ...
            throw FeedManagementServiceError.duplicateFolderName(normalizedName)
        }
    ...
    func updateFolder(_ command: FeedManagementUpdateFolderCommand) throws -> FeedManagementFolderSummary {
        ...
        guard try folderRepository.fetchFolder(id: command.folderID) != nil else {
            ...
            throw FeedManagementServiceError.folderNotFound(command.folderID)
        }
