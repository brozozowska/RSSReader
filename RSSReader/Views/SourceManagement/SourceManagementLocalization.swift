...
enum SourceManagementLocalization {
    ...
    static let folderCreationUnavailableTitle = String(localized: "sourceManagement.createFolder.unavailable.create.title", defaultValue: "Folder creation is unavailable", comment: "Failure title when folder creation service is unavailable.")
    static let folderCreationUnavailableMessage = String(localized: "sourceManagement.createFolder.unavailable.create.detail", defaultValue: "Folder creation is unavailable in the current app environment.", comment: "Failure detail when folder creation service is unavailable in the current app environment.")
    static let folderEditingUnavailableTitle = String(localized: "sourceManagement.createFolder.unavailable.edit.title", defaultValue: "Folder editing is unavailable", comment: "Failure title when folder editing service is unavailable.")
    static let folderEditingUnavailableMessage = String(localized: "sourceManagement.createFolder.unavailable.edit.detail", defaultValue: "Folder editing is unavailable in the current app environment.", comment: "Failure detail when folder editing service is unavailable in the current app environment.")
    static let existingFoldersLoadFailureMessage = String(localized: "sourceManagement.createFolder.error.loadExistingFolders", defaultValue: "Unable to load existing folders right now. Try again.", comment: "Failure message when existing folders cannot be loaded for folder creation.")
    static let folderDetailsLoadFailureMessage = String(localized: "sourceManagement.createFolder.error.loadDetails", defaultValue: "Unable to load the folder details right now. Try again.", comment: "Failure message when folder details cannot be loaded for editing.")
    ...
    static let sourceMovesEnvironmentUnavailableMessage = String(localized: "sourceManagement.moveSource.error.environmentUnavailable", defaultValue: "Source moves are unavailable in the current app environment.", comment: "Failure message when source moves are unavailable in the current app environment.")
    static let existingSourcesLoadFailureMessage = String(localized: "sourceManagement.moveSource.error.loadExistingSources", defaultValue: "Unable to load existing sources right now. Try again.", comment: "Failure message when existing sources cannot be loaded for source moves.")
