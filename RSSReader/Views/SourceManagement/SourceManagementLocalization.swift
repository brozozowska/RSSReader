...
enum SourceManagementLocalization {
    ...
    static let rssFeedKindTitle = String(
        localized: "sourceManagement.feedKind.rss.title",
        defaultValue: "RSS",
        comment: "Technical feed kind title for RSS feeds."
    )
    static let atomFeedKindTitle = String(
        localized: "sourceManagement.feedKind.atom.title",
        defaultValue: "Atom",
    ...
    static let feedAddedDetailFormat = String(
        localized: "sourceManagement.addFeed.status.added.detail.format",
    ...
    static let loadingPreviewAction = String(
        localized: "sourceManagement.addFeed.action.loadingPreview",
    ...
    static let editDisplayNameFooter = String(
        localized: "sourceManagement.addFeed.displayName.edit.footer",
    ...
    static let addDisplayNameFooter = String(
        localized: "sourceManagement.addFeed.displayName.add.footer",
        defaultValue: "Leave the feed title unchanged, or create your own.",
        comment: "Footer for display name while adding a feed."
    )
    static let duplicateSourceNotice = String(
        localized: "sourceManagement.addFeed.duplicate.notice",
    ...
    static let duplicateFeedTitle = String(
        localized: "sourceManagement.addFeed.duplicate.title",
    ...
    static let duplicateFeedDetail = String(
        localized: "sourceManagement.addFeed.duplicate.detail",
    ...
    static let savedEditPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.savedEdit.description",
    ...
    static let savedAddPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.savedAdd.description",
    ...
    static let editPendingPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.editPending.description",
    ...
    static let addPendingPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.addPending.description",
    ...
    static let noFoldersPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.noFolders.description",
    ...
    static let editReadyPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.editReady.description",
    ...
    static let addReadyPlacementDescription = String(
        localized: "sourceManagement.addFeed.placement.addReady.description",
    ...
    static let folderCreatedDetailFormat = String(
        localized: "sourceManagement.createFolder.status.created.detail.format",
        defaultValue: "\"%@\" is ready for sources.",
    ...
    static let folderUpdateFailedTitle = String(
        localized: "sourceManagement.createFolder.status.updateFailed.title",
    ...
    static let folderCreateFailedTitle = String(
        localized: "sourceManagement.createFolder.status.createFailed.title",
    ...
    static let folderCreationUnavailableTitle = String(
        localized: "sourceManagement.createFolder.unavailable.create.title",
    ...
    static let folderCreationUnavailableMessage = String(
        localized: "sourceManagement.createFolder.unavailable.create.detail",
    ...
    static let folderEditingUnavailableTitle = String(
        localized: "sourceManagement.createFolder.unavailable.edit.title",
    ...
    static let folderEditingUnavailableMessage = String(
        localized: "sourceManagement.createFolder.unavailable.edit.detail",
    ...
    static let existingFoldersLoadFailureMessage = String(
        localized: "sourceManagement.createFolder.error.loadExistingFolders",
    ...
    static let folderDetailsLoadFailureMessage = String(
        localized: "sourceManagement.createFolder.error.loadDetails",
    ...
    static let newFolderSummaryTitle = String(
        localized: "sourceManagement.createFolder.new.summary.title",
        defaultValue: "New Folder",
        comment: "Summary title for creating a folder."
    )
    static let newFolderDescription = String(
        localized: "sourceManagement.createFolder.new.summary.description",
    ...
    static let noFoldersTitle = String(
        localized: "sourceManagement.createFolder.empty.title",
        defaultValue: "No folders yet",
        comment: "Empty title when no folders exist."
    )
    static let noFoldersDescription = String(
        localized: "sourceManagement.createFolder.empty.description",
    ...
    static let folderCreationUnavailableValidation = String(
        localized: "sourceManagement.createFolder.validation.unavailable",
    ...
    static let enterFolderNameValidation = String(
        localized: "sourceManagement.createFolder.validation.emptyName",
    ...
    static let duplicateFolderNameValidation = String(
        localized: "sourceManagement.createFolder.validation.duplicateName",
    ...
    static let firstFolderPlacementDescription = String(
        localized: "sourceManagement.createFolder.placement.first.description",
    ...
    static let existingFolderPlacementDescriptionFormat = String(
        localized: "sourceManagement.createFolder.placement.afterExisting.description.format",
    ...
    static let editingFolderPlacementDescriptionFormat = String(
        localized: "sourceManagement.createFolder.placement.editing.description.format",
    ...
    static let sourceMovedTitle = String(
        localized: "sourceManagement.moveSource.status.moved.title",
        defaultValue: "Feed moved",
        comment: "Success title after moving a feed."
    )
    static let sourceMovedDetailFormat = String(
        localized: "sourceManagement.moveSource.status.moved.detail.format",
        defaultValue: "%1$@ now lives in %2$@.",
        comment: "Success detail after moving a feed. Placeholders are feed title and folder title."
    )
    static func sourceMovedDetail(feedTitle: String, folderTitle: String) -> String {
        String.localizedStringWithFormat(sourceMovedDetailFormat, feedTitle, folderTitle)
    }
    static let sourceMoveFailedTitle = String(
        localized: "sourceManagement.moveSource.status.failed.title",
        defaultValue: "Feed could not be moved",
        comment: "Failure title after moving a feed fails."
    )
    static let sourceOrganizationTitle = String(
        localized: "sourceManagement.moveSource.summary.title",
        defaultValue: "Feed Organization",
        comment: "Summary title for move feed flow."
    )
    static let sourceOrganizationDescription = String(
        localized: "sourceManagement.moveSource.summary.description",
    ...
    static let noFeedsTitle = String(
        localized: "sourceManagement.moveSource.empty.title",
        defaultValue: "No existing feeds yet",
        comment: "Empty title when no feeds exist."
    )
    static let noFeedsDescription = String(
        localized: "sourceManagement.moveSource.empty.description",
        defaultValue: "Add a feed first, then return here to move it between folders.",
        comment: "Empty description when no feeds exist."
    )
    static let movingSourceAction = String(
        localized: "sourceManagement.moveSource.action.moving",
        defaultValue: "Moving...",
        comment: "Primary action title while moving a source."
    )
    static let sourceMovesUnavailableMessage = String(
        localized: "sourceManagement.moveSource.error.unavailable",
        defaultValue: "Feed moves are unavailable right now.",
        comment: "Failure message when feed move service is unavailable."
    )
    static let sourceMovesEnvironmentUnavailableMessage = String(
        localized: "sourceManagement.moveSource.error.environmentUnavailable",
    ...
    static let existingSourcesLoadFailureMessage = String(
        localized: "sourceManagement.moveSource.error.loadExistingSources",
    ...
    static let sourceMoveSelectionRequiredMessage = String(
        localized: "sourceManagement.moveSource.error.selectionRequired",
    ...
    static let sourceMoveGenericFailure = String(
        localized: "sourceManagement.moveSource.error.generic",
