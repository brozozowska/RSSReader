...
- [ ] `Feed Icon Rendering Policy`: добавить `FeedIconRenderingPolicy` для видимости иконок на светлой и тёмной теме: определять слабый контраст маленькой иконки относительно текущего фона и добавлять контрастную rounded-square подложку или stroke, не переводя все иконки в grayscale и не меняя исходные cached assets;
