...
- [ ] `Reader Article Image Cache Reset Control`: добавить в самый низ `Settings Screen` кнопку ручной очистки локального кеша изображений статей, чтобы пользователь мог удалить сохранённые на устройстве cache files без переустановки приложения;
