...
- [ ] `Reader Adjacent Navigation Controls Setting`: добавить настройку для выбора способа перехода между соседними статьями: только gestures без toolbar controls, только toolbar controls без gestures или одновременно gestures и toolbar controls;
