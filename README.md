...
- [ ] `Reader Article Image Disk Cache`: добавить bounded disk cache для bytes изображений статей, чтобы кеш переживал перезапуск приложения, экономил трафик и очищался автоматически по LRU при превышении фиксированного лимита;
