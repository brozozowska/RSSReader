...
- [ ] `Article Sync Legacy Cleanup`: после переноса article payload в sync-backed scope удалить оставшийся legacy-код и устаревшие compatibility paths, если они больше не нужны для текущей модели без legacy migration support;
