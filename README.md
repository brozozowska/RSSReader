...
- [ ] вынести preview-only builders из `SourceManagementScreenState` в `SourceManagementScreenPreviewData` или соседний preview factory, чтобы production state не смешивался с dev fixtures;
