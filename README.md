...
- [ ] `Reader Author Display Normalization`: нормализовать отображение автора в `ReaderView`: если feed отдаёт автора вместе с email, показывать только имя и фамилию, а технический email вроде `<name@example.com>` не выводить в reader metadata;
