...
- [ ] `Add Feed Placeholder Simplification`: заменить placeholder адреса источника с точного `example.com/feed.xml` на более общий `example.com`, чтобы поле ввода подсказывало возможность добавить сайт без знания RSS endpoint;
