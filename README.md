...
- [ ] `Reader Adjacent Navigation Mode Options`: расширить настройку навигации между соседними статьями до вариантов `Buttons`, `Swipes`, `Both`, чтобы пользователь мог выбрать только кнопки, только свайпы или оба способа, а selected value оставался коротким и помещался справа в строке настройки;
