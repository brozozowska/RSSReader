...
- [ ] `Unread App Icon Badge`: добавить badge на иконку приложения по количеству непрочитанных статей и обновлять его после refresh, изменения read/unread state и массовых действий;
