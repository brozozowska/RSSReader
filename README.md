...
- [ ] `Article Section Header Blur`: подобрать и реализовать blur/visual effect под sticky заголовками секций на `Articles Screen`, чтобы даты группировки меньше мешали при прокрутке списка статей;
