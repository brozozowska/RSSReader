...
- [ ] `Sources Refresh Indicator Alignment`: проверить refresh-индикаторы на экране источников: manual refresh источников, sidebar refresh status и связанные loading states должны либо использовать общий custom refresh symbol, либо явно остаться на системном UIKit-style indicator, если это часть form/search UX;
